...
bool TerrainClass::Initialize(ID3D11Device* device, ID3D11DeviceContext* deviceContext, char* heightMapFilename, char* materialsFilename, char* materialMapFilename, char* colorMapFilename)
{
	bool result;
	...
	result = LoadMaterialFile(device, deviceContext, materialsFilename, materialMapFilename);
	if(!result)
	{
		return false;
	}
...
bool TerrainClass::LoadMaterialFile(ID3D11Device* device, ID3D11DeviceContext* deviceContext, char* filename, char* materialMapFilename)
{
	ifstream fin;
	char input;
	int i, error;
...
bool TerrainClass::Render(ID3D11DeviceContext* deviceContext, TerrainShaderClass* shader, XMMATRIX worldMatrix, XMMATRIX viewMatrix,
